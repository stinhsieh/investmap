...
/* Mermaid 圖示化（心智圖/魚骨圖/產業鏈）：有 .mermaid 才從 CDN 載入，套深藍金主題 */
(function(){
  if(!document.querySelector('.mermaid')) return;
  var CFG={ startOnLoad:false, securityLevel:'loose', theme:'base',
    themeVariables:{
      fontFamily:"'Noto Sans TC',sans-serif", fontSize:'15px',
      primaryColor:'#ffffff', primaryTextColor:'#2b3244', primaryBorderColor:'#e5e0d5',
      lineColor:'#b98c1f', tertiaryColor:'#f7f4ee', tertiaryTextColor:'#2b3244'
    }};
